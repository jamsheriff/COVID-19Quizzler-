    ...
    //This method will check if the user has got the right answer.
       func checkAnswer() {
           ...
           if correctAnswer == pickedAnswer {
               ...
               correctWrongLabel.textColor = UIColor.green
               score = score + 1
           }
           else {
               
               correctWrongLabel.text = "Wrong!"
                correctWrongLabel.textColor = UIColor.red          }
       }
       ...
       func startOver() {
        ...
        correctWrongLabel.text  = "Choose an Answer!"
        correctWrongLabel.textColor = UIColor.white
         updateUI()
